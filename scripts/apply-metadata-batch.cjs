...
const batch = [
  ...
  ["才二十三", "方大同", "2024", "R&B", "中文"],
  ["九月底", "余佳运", "2017", "流行", "中文"],
  ["那个女孩", "张泽熙", "2017", "流行", "中文", "歌名可能重名；按唱见常见版本默认归入，待歌手本人确认"],
  ["同花顺", "Jony J", "2017", "说唱", "中文", "歌名可能重名；按唱见常见版本默认归入，待歌手本人确认"],
  ["我爱你", "卢广仲", "2011", "流行", "中文", "短歌名可能重名；按唱见常见版本默认归入，待歌手本人确认"],
  ["给电影人的情书", "单依纯", "2020", "流行", "中文", "按唱见常见版本默认归入，待歌手本人确认"],
  ["我的美丽", "小霞", "2015", "流行", "中文", "歌名可能重名；按唱见常见版本默认归入，待歌手本人确认"],
  ["夏夜最后的烟火", "颜人中", "2022", "流行", "中文"],
  ["想念拟人化", "孟慧圆", "2020", "流行", "中文"],
  ["字字句句", "卢卢快闭嘴", "2022", "流行", "中文"],
  ["奥特曼", "旅行团乐队", "2013", "摇滚", "中文", "歌名可能重名；按唱见常见版本默认归入，待歌手本人确认"],
  ["别问很可怕", "J.Sheon", "2018", "R&B", "中文"],
  ["胡广生", "任素汐", "2018", "民谣", "中文"],
  ["寻一个你", "摩登兄弟刘宇宁", "2022", "流行", "中文"],
  ["壁上观", "一棵小葱", "2019", "古风", "中文"],
  ["不枉", "汪苏泷", "2021", "流行", "中文", "短歌名可能重名；按唱见常见版本默认归入，待歌手本人确认"],
  ["不遗憾", "李荣浩", "2020", "流行", "中文"],
  ["成都", "赵雷", "2016", "民谣", "中文", "短歌名可能重名；按唱见常见版本默认归入，待歌手本人确认"],
  ["东北民谣", "毛不易", "2020", "民谣", "中文"],
  ["鸽子", "宋冬野", "2012", "民谣", "中文", "短歌名可能重名；按唱见常见版本默认归入，待歌手本人确认"],
  ["怪天气", "yihuik苡慧", "2021", "流行", "中文"],
  ["轨迹", "周杰伦", "2003", "流行", "中文", "短歌名可能重名；按唱见常见版本默认归入，待歌手本人确认"],
  ["黑白", "方大同", "2008", "R&B", "中文", "短歌名可能重名；按唱见常见版本默认归入，待歌手本人确认"],
  ["美丽谎言", "汪苏泷", "2020", "流行", "中文", "歌名可能重名；按唱见常见版本默认归入，待歌手本人确认"],
  ["你想要的", "颜人中", "2020", "流行", "中文"],
  ["逆战", "张杰", "2012", "流行", "中文", "短歌名可能重名；按唱见常见版本默认归入，待歌手本人确认"],
  ["青花", "周传雄", "2007", "流行", "中文", "短歌名可能重名；按唱见常见版本默认归入，待歌手本人确认"],
  ["情话", "徐良 / 孙羽幽", "2010", "流行", "中文", "短歌名可能重名；按唱见常见版本默认归入，待歌手本人确认"],
  ["让", "杨宗纬", "2008", "流行", "中文", "短歌名可能重名；按唱见常见版本默认归入，待歌手本人确认"],
  ["如果可以", "韦礼安", "2021", "流行", "中文"],
  ["傻子", "林宥嘉", "2012", "流行", "中文", "短歌名可能重名；按唱见常见版本默认归入，待歌手本人确认"],
  ["身骑白马", "徐佳莹", "2009", "流行", "中文"],
  ["绅士", "薛之谦", "2015", "流行", "中文", "短歌名可能重名；按唱见常见版本默认归入，待歌手本人确认"],
  ["神魂颠倒", "邓典", "2021", "流行", "中文"],
  ["神探", "韦礼安", "2014", "流行", "中文", "短歌名可能重名；按唱见常见版本默认归入，待歌手本人确认"],
  ["失格", "小球", "2018", "流行", "中文", "短歌名可能重名；按唱见常见版本默认归入，待歌手本人确认"],
  ["偷心", "张学友", "1994", "流行", "中文", "短歌名可能重名；按唱见常见版本默认归入，待歌手本人确认"],
  ["问", "陈淑桦", "1992", "流行", "中文", "短歌名可能重名；按唱见常见版本默认归入，待歌手本人确认"],
  ["我落泪情绪零碎", "周杰伦", "2010", "流行", "中文"],
  ["我想", "王力宏", "1999", "流行", "中文", "短歌名可能重名；按唱见常见版本默认归入，待歌手本人确认"],
  ["我要我们在一起", "范晓萱", "1999", "流行", "中文"],
  ["我只能离开", "颜人中", "2020", "流行", "中文"],
  ["下雨天", "南拳妈妈", "2008", "流行", "中文"],
  ["夏天的风", "温岚", "2004", "流行", "中文"],
  ["想太多", "李玖哲", "2007", "R&B", "中文"],
  ["心动", "林晓培", "1999", "流行", "中文", "短歌名可能重名；按唱见常见版本默认归入，待歌手本人确认"],
  ["心乱飞", "王力宏", "2005", "R&B", "中文"],
  ["星晴", "周杰伦", "2000", "流行", "中文", "短歌名可能重名；按唱见常见版本默认归入，待歌手本人确认"],
  ["洋葱", "杨宗纬", "2008", "流行", "中文", "短歌名可能重名；按唱见常见版本默认归入，待歌手本人确认"],
  ["野人", "苏打绿", "2009", "摇滚", "中文", "短歌名可能重名；按唱见常见版本默认归入，待歌手本人确认"],
